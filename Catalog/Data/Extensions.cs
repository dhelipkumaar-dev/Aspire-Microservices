...
public class DataSeeder
{
    ...
    [
        new()
        {
            ...
            Price = 19.99m, ImageUrl = "product1.png"
        },
        new()
        {
        ...
        new()
        {
            ...
            Price = 49.99m, ImageUrl = "product3.png"
        },
        new()
        {
        ...
        new()
        {
            Name = "Camping Cookware", Description = "This cookware set is ideal for cooking outdoors", Price = 29.99m,
        ...
        new()
        {
            ...
            Price = 19.99m, ImageUrl = "product8.png"
        },
        new()
        {
